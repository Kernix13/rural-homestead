...
- $400 for spray foam insulation - lay a sub-floor and vinyl tiling
- SATELLITE INTERNET!
- Niche skill and sell stuff
...
- Has there been a professional survey done? A survey is worth its weight in gold
  - Check your local PVA office to see what thye say the acreage is b\c it's usually not accurate, off by no more than 5-8%
...
- Don't buy land-locked land, land where you have to go thru someone elses land to get to the land - that is a huge issue - but if you do make sure the easement is written into the deed
...
- Are utilities close
- Look into mineral rights - you bought the land but may not own what is below the land - like in Eastern Kentucky, almost no one has mineral rights
- Barns - a bran isn't worth anything unless it is well built and has a concrete foundation - it really doesn't add value
...
- is their an easement - is the easement written into the deed
  - `EASEMENT`: a limited right to use the property of another. Common easements include driveways, private roads, and utility rights-of-way for electric, water, or communication lines. Most easements are contained indeeds; some can arise simply due to the passage of time
  - is it land locked -
...
- how accessible to services, food, the raod - how far to the gracery store
...
- FREE INFO: Go down to the `PVA` office & the `Delinquent Tax Office` & the `Deed Room` which is part of a `Title Search`
  - Sheriff's ofice for something ?!?
- make an offer but before the closing do the Title search - if it comes back clear...
...
- Renogy lithium iron phosphate battery - VERY expensive
- mostly he has deep cycle lead acid (flooded) marine batteries, Nautilus Exide, 115 amp hr, deep discharge
- `Adventurer` charge controller, 30 amp
...
- he also has golf cart battteries
- you won't run a refrig off of this - tv, laptop and lights
- maybe a low energy fridge
...
- Renogy 60 ammp MMPT charge controller
- 2000 watt pure sinewave inverter (Renogy)
- power strip attached to the board with velcro
- +/- cables for attaching to the battery
- 20 watt photo voltaic connectors (Renogy)
- $24 total cost
...
- small 20 amp charge controller prismatic lithium cells,
...
- look into mini igloo refrigerators and ice making machines
...
- also positive and negative from the charge controller to the positive/first of the batteries and negative/last of the batteries respectively
  - you need need beefy cables from the charge controller
...
- each battery he has has a regular screw post and a regular lug which is important because you run out of space for the last/first positive/negative because each of those two has a parallel connection, inverter connection, and a converter connection
...
- he has 3 320 watt solar panels on his pvc setup
...
- cordage - search on ebay - sold in mm - he has 4mm 1000 lbs
...
- applicable to all solar briefcases:
  ...
  - none viseod show you how to qquicky & accurately hookup your briefcase
  ...
  - one you are done charging UN-HOOK your solar from the controller
  - charge controller cables
  - leads from the solar panels
  - 1st solar panel hooks to the black thing (switch board connector) on the other one then 2nd solar panel to the mc4 connectors
  ...
  - he soldered the cables from the battery into the controller
